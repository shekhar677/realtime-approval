...
function Home() {
  ...
  async function getDepartment() {
    DataService.getDepartment(AuthService.getCurrentUser().user.department).then(res => {
      ...
      console.log('depart: ',departmentData)
        ...
        <form onSubmit={handleForm}>
          <div className="bg-white rounded p-6 flex flex-col shadow-md" style={{width: '25rem'}}>
            <div className="p-2 flex flex-col text-gray-700 mb-1">
              ...
              <select defaultValue={'DEFAULT'} className="border rounded-md px-3 py-2 capitalize" name="department" id="department" onChange={handleChange}>
            ...
            <div className="p-2 flex flex-col text-gray-700 mb-1">
              ...
              <select defaultValue={'DEFAULT'} disabled={!user.length} className="border rounded-md px-3 py-2" name="assigned_to" id="assigned_to" onChange={handleChange}>
                <option value="DEFAULT" disabled>select an option</option>
            ...
            <div className="p-2 flex flex-col text-gray-700 mb-1">
              ...
              <textarea name="message" id="message" rows="3" placeholder="Your message.." onInput={handleChange} className="resize-none rounded-md px-3 py-2 border"></textarea>
            </div>
